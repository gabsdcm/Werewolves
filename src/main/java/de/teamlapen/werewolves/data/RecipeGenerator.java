...
public class RecipeGenerator extends RecipeProvider {
    ...
    protected void buildRecipes(@Nonnull RecipeOutput consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.WEREWOLF_CLAW_NORMAL.get()).define('P', pelt).define('B', ModItems.CRACKED_BONE.get()).define('S', silver_ingot).pattern("S S").pattern("B B").pattern("P P").unlockedBy("has_pelt", has(pelt)).unlockedBy("has_broken_bone", has(ModItems.CRACKED_BONE.get())).save(consumer);
