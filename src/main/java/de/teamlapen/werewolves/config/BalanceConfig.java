...
public class BalanceConfig {
    ...
    public static class MobProps {
        ...
        public final ModConfigSpec.IntValue werewolf_regen_interval;
        public final ModConfigSpec.DoubleValue werewolf_regen_amount;
        public final ModConfigSpec.DoubleValue werewolf_eat_health_threshold;
        public final ModConfigSpec.IntValue werewolf_eat_cooldown;
        public final ModConfigSpec.DoubleValue werewolf_food_spawn_chance;
        public final ModConfigSpec.DoubleValue werewolf_golden_apple_spawn_chance;
        ...
        public MobProps(ModConfigSpec.Builder builder) {
            ...
            builder.push("werewolf_healing");
            werewolf_regen_interval = builder.comment("Interval at which a werewolf mob regenerates health", "In ticks").defineInRange("werewolf_regen_interval", 60, 1, Integer.MAX_VALUE);
            werewolf_regen_amount = builder.comment("Health regenerated by a werewolf mob per interval").defineInRange("werewolf_regen_amount", 1.0, 0, Double.MAX_VALUE);
            werewolf_eat_health_threshold = builder.comment("Health percentage below which a werewolf mob eats the food in its offhand").defineInRange("werewolf_eat_health_threshold", 0.5, 0, 1);
            werewolf_eat_cooldown = builder.comment("Cooldown between two eat to heal attempts", "In ticks").defineInRange("werewolf_eat_cooldown", 600, 0, Integer.MAX_VALUE);
            werewolf_food_spawn_chance = builder.comment("Chance for a werewolf mob to spawn with food in its offhand").defineInRange("werewolf_food_spawn_chance", 0.35, 0, 1);
            werewolf_golden_apple_spawn_chance = builder.comment("Chance for the spawned offhand food to be a golden apple instead of raw meat").defineInRange("werewolf_golden_apple_spawn_chance", 0.05, 0, 1);
            builder.pop();
